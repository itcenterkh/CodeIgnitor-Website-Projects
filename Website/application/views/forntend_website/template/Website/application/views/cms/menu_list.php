...
<div class="float-left">
    <div class="list-group">
        ...
        <a href="<?= base_url() ?>index.php/admincontroller/add" class="list-group-item list-group-item-info" id="margin">Add Product</a>
        <a href="<?= base_url() ?>index.php/admincontroller/show" class="list-group-item list-group-item-dark" id="margin">Add Categories</a>
